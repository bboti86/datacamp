...
yearly %>% ggplot(aes(x = year, y = proportion_deaths, color = clinic)) + 
geom_line()
```
...
monthly %>% ggplot(aes(x=date, y = proportion_deaths)) + 
geom_line() + 
labs(x = "Date", y = "Death proportions", title = "Deaths over births monthly")
```
...
monthly_summary <- monthly %>% 
  ...
  summarise(effect = mean(proportion_deaths))
...
test_result <- t.test( deaths ~ handwashing_started, data = monthly)
test_result
```

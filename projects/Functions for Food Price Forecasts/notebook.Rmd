...
potato_prices_renamed <- potato_prices %>% rename(region = adm1_name, market = mkt_name, commodity_kg = cm_name, 
...
read_price_data <- function(commodity){potato_prices <- read_csv(
